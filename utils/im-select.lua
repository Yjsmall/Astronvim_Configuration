...
M.windowsFocusGained = function() vim.cmd(":silent :!/usr/local/bin/im-select.exe" .. " " .. Windows.leaveVimIM) end

M.windowsFocusLost = function()
  Windows.leaveVimIM = vim.cmd ":silent :!/usr/local/bin/im-select.exe 1033"
  vim.cmd ":silent :!/usr/local/bin/im-select.exe 1033"
end

M.windowsInsertLeave = function() vim.cmd ":silent :!/usr/local/bin/im-select.exe 1033" end

M.windowsInsertEnter = function() vim.cmd ":silent :!/usr/local/bin/im-select.exe 2052" end
return M
